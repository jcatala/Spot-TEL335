...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__ = __webpack_require__(195);
...
var HomePage = (function () {
    function HomePage(navCtrl, geolocation, googleMaps) {
    ...
    HomePage.prototype.loadMap = function (positiona) {
        ...
        var myPosition = new __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__["c" /* LatLng */](latitude, longitud);
        // CAMERA POSITION
        var position = {
            target: myPosition,
            zoom: 18,
        ...
        map.one(__WEBPACK_IMPORTED_MODULE_3__ionic_native_google_maps__["b" /* GoogleMapsEvent */].MAP_READY).then(function () {
